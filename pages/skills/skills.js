...
Page({
  data: { skills: skillsData, filtered: skillsData, search: '', type: '全部', types: ['全部','普�?,'�?,'�?,'�?,'�?,'�?,'�?,'�?,'�?,'�?,'�?,'�?,'机械','�?,'�?,'�?] },
  ...
  showDetail: function(e) {
    ...
    wx.showModal({ title: s.name, content: '【技能信息】\n属�? ' + s.type + '\n分类: ' + s.category + '\n威力: ' + (s.power > 0 ? s.power : '变化') + '\nPP: ' + s.pp + '\n\n【技能效果】\n' + s.desc + '\n\n【数据来源】\n洛克王国手游WIKI（CC BY-NC-SA 4.0）\nhttps://wiki.biligame.com/rocom/技能图�?, showCancel: false })
  },
  go: function(e) { wx.navigateTo({ url: e.currentTarget.dataset.url }) },
  onShareAppMessage: function() {
    return { title: '洛手助手 - 技能图�?, path: '/pages/skills/skills', imageUrl: '/images/banner.webp' }
  },
  onShareTimeline: function() {
    return { title: '洛手助手 - 洛克王国技能图鉴大�?, imageUrl: '/images/banner.webp' }
  }
})
